...
motor leftDriveTMotorA = motor(PORT6, ratio6_1, false);
motor leftDriveTMotorB = motor(PORT10, ratio6_1, false);
motor_group leftDriveT = motor_group(leftDriveTMotorA, leftDriveTMotorB);
motor rightDriveTMotorA = motor(PORT4, ratio6_1, true);
motor rightDriveTMotorB = motor(PORT8, ratio6_1, true);
motor_group rightDriveT = motor_group(rightDriveTMotorA, rightDriveTMotorB);
motor leftmidM = motor(PORT9, ratio6_1, true);
motor rightmidM = motor(PORT5, ratio6_1, false);
